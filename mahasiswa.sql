...
insert into jurusan (1,Pendidikan Bahasa Indonesia) values ('APBL','Pendidikan Bahasa Indonesia');
...
values (1,'2022000', 'Ghina', 'perempun', 'Malang', '2001-04-22', 'Malang');
insert into mahasiswa (id_jurusan, nim, nama, jenis_kelamin, tempat_lahir, tanggal_lahir, alamat)
values (1,'20220001', 'Farul', 'laki-laki', 'Malang', '2001-05-24', 'Surabaya');
